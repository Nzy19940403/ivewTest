(function($) {
    ...
    function _354(_355) {
        ...
        $(_355).children("div.tabs-header").unbind().bind("click",
        function(e) {
    ...
    $.fn.tabs = function(_39c, _39d) {
        ...
        return this.each(function() {
            ...
            if (_39e) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({},
                    $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _39c),
                    tabs: [],
                    selectHis: []
                });
                _350(this);
    ...
    $.fn.tabs.parseOptions = function(_3ab) {
        return $.extend({},
        $.parser.parseOptions(_3ab, ["tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean"
        },
    ...
    function _3e8(_3e9, _3ea, _3eb) {
            ...
            if (!_3ed.expandMode) {
                ...
                function() {
                    if (_3ed.expandMode == "dock") {
                        ...
                        p.panel("panel").animate(_3f0.expand,
                        function() {
        ...
        p.panel("panel").animate(_3f2.collapse, _3eb,
        function() {
    ...
    function _3fb(_3fc, _3fd) {
        ...
        if (_3fe[_400]) {
            ...
            p.panel("panel").animate(_401.expand,
            function() {
                _3bc(_3fc);
    ...
    $.fn.layout = function(_410, _411) {
        ...
        return this.each(function() {
            ...
            if (_412) {
                ...
                var opts = $.extend({},
                $.fn.layout.defaults, $.fn.layout.parseOptions(this), _410);
                $.data(this, "layout", {
                    options: opts,
                    panels: {
                        center: $(),
    ...
    $.fn.layout.parsePanelOptions = function(_420) {
        var t = $(_420);
        return $.extend({},
        $.fn.panel.parseOptions(_420), $.parser.parseOptions(_420, ["region", {
            split: "boolean",
    ...
    $.fn.menu = function(_46b, _46c) {
        ...
        return this.each(function() {
            ...
            if (_46d) {
                ...
                _46d = $.data(this, "menu", {
                    options: $.extend({},
                    $.fn.menu.defaults, $.fn.menu.parseOptions(this), _46b)
                });
                init(this);
            }
            $(this).css({
        ...
        return this.each(function() {
            ...
            if (_49c) {
                ...
                _49c = $.data(this, "sidemenu", {
                    options: $.extend({},
                    $.fn.sidemenu.defaults, $.fn.sidemenu.parseOptions(this), _499)
                });
                init(this);
            }
            _47c(this);
    ...
    $.fn.sidemenu.parseOptions = function(_49e) {
        var t = $(_49e);
        return $.extend({},
        $.parser.parseOptions(_49e, ["width", "height"]));
    };
        ...
        return this.each(function() {
            ...
            if (_4af) {
                ...
                $.data(this, "menubutton", {
                    options: $.extend({},
                    $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _4ac)
                });
                $(this)._propAttr("disabled", false);
            }
            init(this);
    ...
    $.fn.menubutton.parseOptions = function(_4b1) {
        var t = $(_4b1);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_4b1), $.parser.parseOptions(_4b1, ["menu", {
            plain: "boolean",
        ...
        return this.each(function() {
            ...
            if (_4b6) {
                ...
                $.data(this, "splitbutton", {
                    options: $.extend({},
                    $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _4b3)
                });
                $(this)._propAttr("disabled", false);
            }
            init(this);
    ...
    $.fn.splitbutton.parseOptions = function(_4b9) {
        var t = $(_4b9);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_4b9), $.parser.parseOptions(_4b9, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
    ...
    function _4dd(_4de) {
        ...
        _4df.switchbutton.unbind(".switchbutton").bind("click.switchbutton",
        function() {
        ...
        return this.each(function() {
            ...
            if (_4e2) {
                ...
                _4e2 = $.data(this, "switchbutton", {
                    options: $.extend({},
                    $.fn.switchbutton.defaults, $.fn.switchbutton.parseOptions(this), _4e0),
    ...
    $.fn.switchbutton.parseOptions = function(_4e6) {
        var t = $(_4e6);
        return $.extend({},
        $.parser.parseOptions(_4e6, ["onText", "offText", "handleText", {
            handleWidth: "number",
            reversed: "boolean"
        }]), {
    ...
    function _4f2(_4f3) {
        ...
        _4f5.unbind(".radiobutton").bind("click.radiobutton",
        function() {
            if (!opts.disabled) {
                _4f0(_4f3, true);
            }
        ...
        return this.each(function() {
            ...
            if (_504) {
                ...
                _504 = $.data(this, "radiobutton", {
                    options: $.extend({},
                    $.fn.radiobutton.defaults, $.fn.radiobutton.parseOptions(this), _502),
    ...
    $.fn.radiobutton.parseOptions = function(_507) {
        var t = $(_507);
        return $.extend({},
        $.parser.parseOptions(_507, ["label", "labelPosition", "labelAlign", {
            labelWidth: "number"
        }]), {
            value: (t.val() || undefined),
            checked: (t.attr("checked") ? true: undefined),
    ...
    function _513(_514) {
        ...
        _516.unbind(".checkbox").bind("click.checkbox",
        function() {
            if (!opts.disabled) {
        ...
        return this.each(function() {
            ...
            if (_526) {
                ...
                _526 = $.data(this, "checkbox", {
                    options: $.extend({},
                    $.fn.checkbox.defaults, $.fn.checkbox.parseOptions(this), _524),
                    checkbox: init(this)
                });
            }
    ...
    $.fn.checkbox.parseOptions = function(_529) {
        var t = $(_529);
        return $.extend({},
        $.parser.parseOptions(_529, ["label", "labelPosition", "labelAlign", {
            labelWidth: "number"
        }]), {
            value: (t.val() || undefined),
            checked: (t.attr("checked") ? true: undefined),
    ...
    function _532(e) {
        ...
        _534.value = opts.val(_533); (function() {
            if (!$(_533).is(":visible")) {
        ...
        return this.each(function() {
            ...
            if (_55a) {
                ...
                _55a = $.data(this, "validatebox", {
                    options: $.extend({},
                    $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), _558)
                });
            }
    ...
    $.fn.validatebox.parseOptions = function(_55b) {
        var t = $(_55b);
        return $.extend({},
        $.parser.parseOptions(_55b, ["validType", "missingMessage", "invalidMessage", "tipPosition", {
            delay: "number",
            interval: "number",
            deltaX: "number"
        },
        ...
        return this.each(function() {
            ...
            if (_59c) {
                ...
                _59c = $.data(this, "textbox", {
                    options: $.extend({},
                    $.fn.textbox.defaults, $.fn.textbox.parseOptions(this), _598),
                    textbox: init(this)
                });
    ...
    $.fn.textbox.parseOptions = function(_5b7) {
        var t = $(_5b7);
        return $.extend({},
        $.fn.validatebox.parseOptions(_5b7), $.parser.parseOptions(_5b7, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", "label", "labelPosition", "labelAlign", {
            multiline: "boolean",
            iconWidth: "number",
            labelWidth: "number"
        }]), {
    ...
    function _5bf(_5c0) {
        ...
        $(_5c0).addClass("passwordbox-f").textbox($.extend({},
        opts, {
            icons: _5c2
        }));
        _5c3(_5c0);
    ...
    function _5cb(e) {
        ...
        _5cd.checking = true;
        _5cd.value = t.passwordbox("getText"); (function() {
            if (_5cd.checking) {
        ...
        return this.each(function() {
            ...
            if (_5d5) {
                ...
                _5d5 = $.data(this, "passwordbox", {
                    options: $.extend({},
                    $.fn.passwordbox.defaults, $.fn.passwordbox.parseOptions(this), _5d2)
                });
            }
            _5bf(this);
        });
    ...
    $.fn.passwordbox.parseOptions = function(_5d7) {
        return $.extend({},
        $.fn.textbox.parseOptions(_5d7), $.parser.parseOptions(_5d7, ["passwordChar", {
    ...
    $.fn.maskedbox = function(_5fd, _5fe) {
        ...
        return this.each(function() {
            ...
            if (_600) {
                ...
                $.data(this, "maskedbox", {
                    options: $.extend({},
                    $.fn.maskedbox.defaults, $.fn.maskedbox.parseOptions(this), _5fd)
                });
            }
            _5d9(this);
        });
    ...
    $.fn.maskedbox.parseOptions = function(_603) {
        var t = $(_603);
        return $.extend({},
        $.fn.textbox.parseOptions(_603), $.parser.parseOptions(_603, ["mask", "promptChar"]), {});
    };
    ...
    $.fn.filebox = function(_60c, _60d) {
        ...
        return this.each(function() {
            ...
            if (_60f) {
                ...
                $.data(this, "filebox", {
                    options: $.extend({},
                    $.fn.filebox.defaults, $.fn.filebox.parseOptions(this), _60c)
                });
            }
            _605(this);
        });
    ...
    $.fn.filebox.parseOptions = function(_610) {
        var t = $(_610);
        return $.extend({},
        $.fn.textbox.parseOptions(_610), $.parser.parseOptions(_610, ["accept", "capture", "separator"]), {
    ...
    function _611(_612) {
        ...
        _615();
        var _616 = _617();
        $(_612).addClass("searchbox-f").textbox($.extend({},
        opts, {
            icons: _614,
    ...
    $.fn.searchbox = function(_61c, _61d) {
        ...
        return this.each(function() {
            ...
            if (_61f) {
                ...
                $.data(this, "searchbox", {
                    options: $.extend({},
                    $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _61c)
                });
            }
            _611(this);
        });
    ...
    $.fn.searchbox.parseOptions = function(_620) {
        var t = $(_620);
        return $.extend({},
        $.fn.textbox.parseOptions(_620), $.parser.parseOptions(_620, ["menu"]), {
    ...
    function _64f(_650, _651) {
        ...
        if (_652) {
            ...
            $.data(_650, "form", {
                options: $.extend({},
                $.fn.form.defaults, $.fn.form.parseOptions(_650), _651)
            });
        }
    };
    function _653(_654) {
        ...
        return this.each(function() {
            ...
            if (_66c) {
                ...
                _66c = $.data(this, "numberbox", {
                    options: $.extend({},
                    $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _669)
                });
            }
            _660(this);
        });
    ...
    $.fn.numberbox.parseOptions = function(_66f) {
        var t = $(_66f);
        return $.extend({},
        $.fn.textbox.parseOptions(_66f), $.parser.parseOptions(_66f, ["decimalSeparator", "groupSeparator", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
        }]), {
    ...
    function _678(_679) {
        ...
        $(_679).unbind(".calendar").bind("mouseover.calendar",
        function(e) {
            var t = _67b(e.target);
        ...
        return this.each(function() {
            ...
            if (_69e) {
                ...
                _69e = $.data(this, "calendar", {
                    options: $.extend({},
                    $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _69c)
                });
                init(this);
            }
    ...
    $.fn.calendar.parseOptions = function(_6a1) {
        var t = $(_6a1);
        return $.extend({},
        $.parser.parseOptions(_6a1, ["weekNumberHeader", {
            firstDay: "number",
            fit: "boolean",
            border: "boolean",
            showWeek: "boolean"
    ...
    function _6a6(_6a7) {
        ...
        $(_6a7).addClass("spinner-f").textbox($.extend({},
        opts, {
            icons: _6a9,
            doSize: false,
        ...
        return this.each(function() {
            ...
            if (_6b9) {
                ...
                _6b9 = $.data(this, "spinner", {
                    options: $.extend({},
                    $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), _6b6)
                });
            }
            _6a6(this);
        });
    ...
    $.fn.spinner.parseOptions = function(_6ba) {
        return $.extend({},
        $.fn.textbox.parseOptions(_6ba), $.parser.parseOptions(_6ba, ["min", "max", "spinAlign", {
            increment: "number",
            reversed: "boolean"
        }]));
    };
        ...
        return this.each(function() {
            ...
            if (_6c2) {
                ...
                $.data(this, "numberspinner", {
                    options: $.extend({},
                    $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _6bf)
                });
            }
            _6bb(this);
        });
    ...
    $.fn.numberspinner.parseOptions = function(_6c3) {
        return $.extend({},
        $.fn.spinner.parseOptions(_6c3), $.fn.numberbox.parseOptions(_6c3), {});
    };
        ...
        return this.each(function() {
            ...
            if (_6d8) {
                ...
                $.data(this, "timespinner", {
                    options: $.extend({},
                    $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _6d5)
                });
            }
            _6c4(this);
        });
    ...
    $.fn.timespinner.parseOptions = function(_6da) {
        return $.extend({},
        $.fn.spinner.parseOptions(_6da), $.parser.parseOptions(_6da, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
        ...
        return this.each(function() {
            ...
            if (_6e3) {
                ...
                $.data(this, "datetimespinner", {
                    options: $.extend({},
                    $.fn.datetimespinner.defaults, $.fn.datetimespinner.parseOptions(this), _6e0)
                });
            }
            _6de(this);
        });
    ...
    $.fn.datetimespinner.parseOptions = function(_6e4) {
        return $.extend({},
        $.fn.timespinner.parseOptions(_6e4), $.parser.parseOptions(_6e4, []));
    };
    ...
    function _720(_721, _722) {
        ...
        function _724(_725) {
            var _726 = _725 ? 1 : 2;
            var tr = opts.finder.getTr(_721, _722, "body", _726); (_725 ? dc.body1: dc.body2).children("table.datagrid-btable-frozen").append(tr);
        };
    };
    ...
    function _857(_858) {
        ...
        function _860(ids, _861) {
            for (var i = 0; i < ids.length; i++) {
                ...
                if (_862 >= 0) { (_861 == "s" ? _76c: _769)(_858, _862, true);
                }
            }
        };
    ...
    function _782(_865, _866, cb) {
        ...
        var _868 = opts.loader.call(_865, _867,
        function(data) {
    ...
    var _880 = $.extend({},
    _872(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
    ...
    $.fn.datagrid.parseOptions = function(_8c6) {
        var t = $(_8c6);
        return $.extend({},
        $.fn.panel.parseOptions(_8c6), $.parser.parseOptions(_8c6, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    var _8c9 = {
        ...
        renderEmptyRow: function(_90c) {
            var cols = $.map($(_90c).datagrid("getColumnFields"),
            function(_90d) {
    ...
    $.fn.propertygrid = function(_955, _956) {
        ...
        return this.each(function() {
            ...
            if (_958) {
                ...
                var opts = $.extend({},
                $.fn.propertygrid.defaults, $.fn.propertygrid.parseOptions(this), _955);
                opts.frozenColumns = $.extend(true, [], opts.frozenColumns);
                opts.columns = $.extend(true, [], opts.columns);
    ...
    $.fn.propertygrid.parseOptions = function(_959) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_959), $.parser.parseOptions(_959, [{
            showGroup: "boolean"
        }]));
    };
    var _95a = $.extend({},
    ...
    function _9c1(_9fa, _9fb, _9fc, _9fd, _9fe) {
        ...
        var _a01 = opts.loader.call(_9fa, _9ff,
        function(data) {
    ...
    function _a17(_a18, _a19) {
        ...
        if (_a1a.length) {
            ...
            _9c1(_a18, row[opts.idField], _a1c, true,
            function() {
                if (cc.is(":empty")) {
                    _a1a.remove();
                } else {
        ...
        return this.each(function() {
            ...
            if (_a49) {
                ...
                _a49 = $.data(this, "treegrid", {
                    options: $.extend({},
                    $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _a46),
                    data: [],
                    checkedRows: [],
                    tmpIds: []
                });
    ...
    $.fn.treegrid.methods = {
        ...
        clearChecked: function(jq) {
            return jq.each(function() {
                ...
                $.map($(_a54).treegrid("getCheckedNodes"),
                function(row) {
    ...
    $.fn.treegrid.parseOptions = function(_a55) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_a55), $.parser.parseOptions(_a55, ["treeField", {
            checkbox: "boolean",
            cascadeCheck: "boolean",
            onlyLeafCheck: "boolean"
        },
    ...
    $.fn.datalist = function(_abb, _abc) {
        ...
        return this.each(function() {
            ...
            if (_abe) {
                ...
                var opts = $.extend({},
                $.fn.datalist.defaults, $.fn.datalist.parseOptions(this), _abb);
                opts.columns = $.extend(true, [], opts.columns);
    ...
    $.fn.datalist.parseOptions = function(_abf) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_abf), $.parser.parseOptions(_abf, ["valueField", "textField", "groupField", {
            checkbox: "boolean",
            lines: "boolean"
        }]));
    };
    ...
    function _ac5(_ac6) {
        ...
        $(_ac6).addClass("combo-f").textbox($.extend({},
        opts, {
            icons: _acc,
            onChange: function() {}
        }));
        ...
        return this.each(function() {
            ...
            if (_b0a) {
                ...
                _b0a = $.data(this, "combo", {
                    options: $.extend({},
                    $.fn.combo.defaults, $.fn.combo.parseOptions(this), _b07),
                    previousText: ""
                });
    ...
    $.fn.combo.parseOptions = function(_b0d) {
        var t = $(_b0d);
        return $.extend({},
        $.fn.textbox.parseOptions(_b0d), $.parser.parseOptions(_b0d, ["separator", "panelAlign", {
            panelWidth: "number",
            hasDownArrow: "boolean",
            delay: "number",
            reversed: "boolean",
    ...
    function _b2f(_b30, data, _b31) {
        ...
        $.easyui.forEach(_b32.data, false,
        function(row) {
            if (row["selected"]) {
    ...
    function _b33(_b34, url, _b35, _b36) {
        ...
        _b35 = $.extend({},
        opts.queryParams, _b35 || {});
        if (opts.onBeforeLoad.call(_b34, _b35) == false) {
            return;
        }
        opts.loader.call(_b34, _b35,
        function(data) {
            _b2f(_b34, data, _b36);
        },
        function() {
        ...
        return this.each(function() {
            ...
            if (_b54) {
                ...
                _b54 = $.data(this, "combobox", {
                    options: $.extend({},
                    $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _b51),
                    data: []
                });
            }
            _b43(this);
    ...
    $.fn.combobox.parseOptions = function(_b5c) {
        var t = $(_b5c);
        return $.extend({},
        $.fn.combo.parseOptions(_b5c), $.parser.parseOptions(_b5c, ["valueField", "textField", "groupField", "groupPosition", "mode", "method", "url", {
    ...
    $.fn.combotree = function(_b9b, _b9c) {
        ...
        return this.each(function() {
            ...
            if (_b9e) {
                ...
                $.data(this, "combotree", {
                    options: $.extend({},
                    $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _b9b)
                });
            }
            _b7f(this);
        });
    ...
    $.fn.combotree.parseOptions = function(_ba4) {
        return $.extend({},
        $.fn.combo.parseOptions(_ba4), $.fn.tree.parseOptions(_ba4));
    };
    ...
    function _ba5(_ba6) {
        ...
        var grid = _ba7.grid;
        $(_ba6).addClass("combogrid-f").combo($.extend({},
        opts, {
            onShowPanel: function() {
    ...
    function _bbe(_bc3, _bc4, _bc5) {
        ...
        var _bcf = $.grep(grid.datagrid("getSelections"),
        function(row, _bd0) {
        ...
        return this.each(function() {
            ...
            if (_be2) {
                ...
                _be2 = $.data(this, "combogrid", {
                    options: $.extend({},
                    $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _bdf)
                });
            }
            _ba5(this);
        });
    ...
    $.fn.combogrid.parseOptions = function(_be7) {
        var t = $(_be7);
        return $.extend({},
        $.fn.combo.parseOptions(_be7), $.fn.datagrid.parseOptions(_be7), $.parser.parseOptions(_be7, ["idField", "textField", "mode"]));
    };
    ...
    function _be9(_bea) {
        ...
        $(_bea).addClass("combotreegrid-f").combo($.extend({},
        opts, {
            onShowPanel: function() {
        ...
        return this.each(function() {
            ...
            if (_c09) {
                ...
                _c09 = $.data(this, "combotreegrid", {
                    options: $.extend({},
                    $.fn.combotreegrid.defaults, $.fn.combotreegrid.parseOptions(this), _c06)
                });
            }
            _be9(this);
        });
    ...
    $.fn.combotreegrid.parseOptions = function(_c0e) {
        var t = $(_c0e);
        return $.extend({},
        $.fn.combo.parseOptions(_c0e), $.fn.treegrid.parseOptions(_c0e), $.parser.parseOptions(_c0e, ["mode", {
            limitToGrid: "boolean"
        }]));
    };
    ...
    function _c10(_c11) {
        ...
        $(_c11).addClass("tagbox-f").combobox($.extend({},
        opts, {
            cls: "tagbox",
            reversed: true,
    ...
    $.fn.tagbox = function(_c3b, _c3c) {
        ...
        return this.each(function() {
            ...
            if (_c3e) {
                ...
                $.data(this, "tagbox", {
                    options: $.extend({},
                    $.fn.tagbox.defaults, $.fn.tagbox.parseOptions(this), _c3b)
                });
            }
            _c10(this);
            _c27(this);
    ...
    $.fn.tagbox.parseOptions = function(_c41) {
        return $.extend({},
        $.fn.combobox.parseOptions(_c41), $.parser.parseOptions(_c41, []));
    };
    ...
    function _c49(_c4a) {
        ...
        $(_c4a).addClass("datebox-f").combo($.extend({},
        opts, {
            onShowPanel: function() {
                _c4c(this);
                _c4d(this);
        ...
        function _c4c(_c51) {
            ...
            _c52.unbind(".datebox").bind("click.datebox",
            function(e) {
    ...
    $.fn.datebox = function(_c66, _c67) {
        ...
        return this.each(function() {
            ...
            if (_c69) {
                ...
                $.data(this, "datebox", {
                    options: $.extend({},
                    $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _c66)
                });
            }
            _c49(this);
        });
    ...
    $.fn.datebox.parseOptions = function(_c6e) {
        return $.extend({},
        $.fn.combo.parseOptions(_c6e), $.parser.parseOptions(_c6e, ["sharedCalendar"]));
    };
        ...
        return this.each(function() {
            ...
            if (_c89) {
                ...
                $.data(this, "datetimebox", {
                    options: $.extend({},
                    $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _c86)
                });
            }
            _c74(this);
        });
    ...
    $.fn.datetimebox.parseOptions = function(_c8e) {
        var t = $(_c8e);
        return $.extend({},
        $.fn.datebox.parseOptions(_c8e), $.parser.parseOptions(_c8e, ["timeSeparator", "spinnerWidth", {
            showSeconds: "boolean"
        }]));
    };
    ...
    function _cab(_cac) {
        ...
        _cae.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",
        function(e) {
    ...
    function _cb8(_cb9, _cba) {
        ...
        var _cbe = [];
        if (!$.isArray(_cba)) {
            _cba = $.map(String(_cba).split(opts.separator),
            function(v) {
                return parseFloat(v);
            });
        }
        ...
        return this.each(function() {
            ...
            if (_ccf) {
                ...
                _ccf = $.data(this, "slider", {
                    options: $.extend({},
                    $.fn.slider.defaults, $.fn.slider.parseOptions(this), _ccd),
                    slider: init(this)
                });
                $(this)._propAttr("disabled", false);
            }
    ...
    $.fn.slider.parseOptions = function(_cd3) {
        var t = $(_cd3);
        return $.extend({},
        $.parser.parseOptions(_cd3, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
